                ...
                <v-list-item v-for="(data, n) in values" :key="n">
                    ...
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle style="font-size:25px; font-weight:700;">
                            ...
                            [ MaintenanceSeq :  {{data.maintenanceSeq }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ MaintenanceCompanyCode :  {{data.maintenanceCompanyCode }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ MaintenanceItemCode :  {{data.maintenanceItemCode }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            [ PreventiveMaintenanceItem :  {{data.preventiveMaintenanceItem }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
